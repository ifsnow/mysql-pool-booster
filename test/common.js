...
common.testLib = path.resolve(__dirname, 'lib');
...
common.Charsets         = require(common.testLib + '/protocol/constants/charsets');
common.ClientConstants  = require(common.testLib + '/protocol/constants/client');
common.Connection       = require(common.testLib + '/Connection');
common.ConnectionConfig = require(common.testLib + '/ConnectionConfig');
common.Errors           = require(common.testLib + '/protocol/constants/errors');
common.Packets          = require(common.testLib + '/protocol/packets');
common.PacketWriter     = require(common.testLib + '/protocol/PacketWriter');
common.Parser           = require(common.testLib + '/protocol/Parser');
common.PoolConfig       = require(common.lib + '/PoolConfig');
common.PoolConnection   = require(common.lib + '/PoolConnection');
common.SqlString        = require(common.testLib + '/protocol/SqlString');
common.Types            = require(common.testLib + '/protocol/constants/types');

var Mysql      = require('mysql');
var MysqlPoolBooster = require(path.resolve(common.lib, '../index'));
